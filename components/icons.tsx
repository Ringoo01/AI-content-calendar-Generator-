...
export const SnapchatIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10c.99 0 1.95-.14 2.86-.41.05-.02.1-.03.14-.06.4-.18.78-.4.92-.86.1-.33-.04-.68-.34-.88-.3-.2-.68-.24-.98-.07-.8.44-1.69.68-2.6.68-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8c0 1.17-.25 2.27-.72 3.25-.13.26-.07.58.15.78.22.2.53.23.78.06.46-.31.87-.68 1.22-1.12.33-.41.56-.88.67-1.38.03-.13.05-.26.07-.39C21.86 13.95 22 12.99 22 12c0-5.52-4.48-10-10-10zm-3.5 8c-.83 0-1.5.67-1.5 1.5s.67 1.5 1.5 1.5 1.5-.67 1.5-1.5S9.33 10 8.5 10zm7 0c-.83 0-1.5.67-1.5 1.5s.67 1.5 1.5 1.5 1.5-.67 1.5-1.5-.67-1.5-1.5-1.5z" />
    </svg>
);

export const MetaIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
        <path d="M22.05 11.23c0-1.43-.9-2.7-2.28-3.13-1.1-.34-2.32.2-2.93 1.28l-3.32 5.85-3.32-5.85c-.6-1.07-1.83-1.62-2.93-1.28-1.38.43-2.28 1.7-2.28 3.13v1.54c0 .87.31 1.71.87 2.37l4.5 5.25c.97 1.13 2.63 1.13 3.6 0l4.5-5.25c.56-.66.87-1.5.87-2.37v-1.54z" />
    </svg>
);